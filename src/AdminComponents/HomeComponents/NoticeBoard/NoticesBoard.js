...
const NoticeBoard = () => {
    ...
    return(
        <span>
            ...
            <Link to="/admin/notices" style={{color: "white", textDecoration: "none"}}><div className="manage-notices-btn-inside">Manage Notices</div></Link>
        <div className="notice-board-container">
            ...
            <div className="view-all">
                <span><Link to="admin/notices">View all</Link></span>
            </div>
        </div>
        <ToastContainer 
